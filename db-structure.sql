...
-- -----------------------------------------------------
-- Table bandify.musicGroups (updated to match requirements)
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS bandify.musicGroups (
                                                   groupId INT(30) NOT NULL AUTO_INCREMENT, -- Renamed for clarity
                                                   userId INT(30) NOT NULL, -- Renamed to match users table
                                                   groupName CHAR(50) NOT NULL, -- Name of the band
                                                   groupDescription TEXT NOT NULL, -- Description of the band
